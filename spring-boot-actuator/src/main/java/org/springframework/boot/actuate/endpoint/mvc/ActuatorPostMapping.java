 ...
 *
 * <p>
 *     针对使用application / json或application / vnd.spring-boot.actuator.v1 + json请求并生成application / json或application / vnd.spring-boot.actuator.v1 + json响应的POST请求的专用的RequestMapping。
 * </p>
 *
